...
public extension Sequence {
    ...
    ///  given a mutable initial value.
    ///
    /// - Parameters:
    ///   - initialResult: The value to use as the initial accumulating value. The `nextPartialResult`
    ...
    ///    asynchronous sequence into a new accumulating value, for use in the next call of the `nextPartialResult
